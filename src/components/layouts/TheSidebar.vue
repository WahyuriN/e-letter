  ...
  <div 
    ...
    <header class="flex items-center pt-10 px-5">
      ...
      <div class="ml-2 flex flex-col">
        <h1 class="text-sm text-gray-700 font-medium">FKSP UNSIQ</h1>
        <p class="text-gray-400 text-xs">Fakultas </p>
      </div>
    </header>
    <!-- Menu -->
    <div class="mt-14">
